...
AUTH_LDAP_SERVER_URI='ldap://4212-DC0KHA021.orient.root.biz'
AUTH_LDAP_BIND_DN="CN=dvarzhba, CN=Users, DC=orient, DC=root, DC=biz"
AUTH_LDAP_BIND_PASSWORD=""
AUTH_LDAP_USER_SEARCH=LDAPSearch(
"ou=Users, dc=orient, dc=root, dc=biz", ldap.SCOPE_SUBTREE, "(uid=%(user)s)"
)
...
"dc=orient, dc=root, dc=biz", ldap.SCOPE_SUBTREE, "(objectClass=groupOfNames)")
AUTH_LDAP_GROUP_TYPE=GroupOfNamesType(name_attr="cn")
AUTH_LDAP_USER_FLAGS_BY_GROUP={
"is_superuser":"CN=Domain Users, DC=orient, DC=root, DC=biz",
"is_staff":"CN=Domain Users, DC=orient, DC=root, DC=biz",
}
